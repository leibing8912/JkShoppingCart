...
public class ShoppingCartModel implements ShoppingCartInterface.UIToDataInterface {
     ...
     * @createTime 2017/5/4
     * @lastModify 2017/5/4
     * @param mModelListener model listener
     * @return
     */
    public ShoppingCartModel(ModelListener mModelListener){
    ...
    public void saveBeforeEditData(Object object) {
        if (object != null){
            ...
            lSpLocalCache.save(AppManager.getInstance().currentActivity()
                    .getApplicationContext(), mListCache, new SpLocalCache.CacheCallBackListener() {
                @Override
    ...
    public void getBeforeEditData() {
        if (lSpLocalCache == null || mModelListener == null)
            return;
        lSpLocalCache.read(AppManager.getInstance().currentActivity().getApplicationContext(),
